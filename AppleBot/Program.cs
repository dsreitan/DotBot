...
var playerOne = new ApplePlayerBot(host.Services.CreateScope().ServiceProvider);
...
Game game = gameSettings.GameMode switch
{
    ...
    GameMode.Multiplayer or _ =>
        new MultiplayerGame(gameSettings, playerOne, new ApplePlayerBot(host.Services.CreateScope().ServiceProvider))
};
